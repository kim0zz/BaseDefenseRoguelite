...
public static class SkillContentFactory
{
    ...
    public static SkillDefinition CreateBombermanWybuchowyOdskok()
    {
        var skill = ScriptableObject.CreateInstance<SkillDefinition>();
        SetField(skill, "skillId", "bomberman_wybuchowy_odskok");
        SetField(skill, "displayName", "Wybuchowy odskok");
        SetField(skill, "ownerClass", PlayerClassId.Bomberman);
        SetField(skill, "skillSlotIndex", 1);
        SetField(skill, "windupSeconds", 0.06f);
        SetField(skill, "activeSeconds", DeployableTuning.DashActiveSeconds);
        SetField(skill, "recoverySeconds", 0.12f);
        SetField(skill, "windupMoveMultiplier", 0.8f);
        SetField(skill, "recoveryMoveMultiplier", 0.6f);
        SetField(skill, "locksFacingInActive", false);
        SetField(skill, "cooldownSeconds", 5.5f);
        SetField(skill, "maxCharges", 1);
        SetField(skill, "cooldownStartsOnActive", true);
        SetField(skill, "aimMode", SkillAimMode.Self);
        SetField(skill, "locomotion", SkillLocomotionMode.Charge);
        SetField(skill, "hitPolicy", SkillHitPolicy.OnEnteredActive);
        SetField(skill, "shapeType", SkillShapeType.PlaceAndDash);
        SetField(skill, "chargeSpeed", DeployableTuning.DashSpeed);
        SetField(skill, "radiusMeters", DeployableTuning.DashChargeRadius);
        SetField(skill, "damage", 0f);
        SetField(skill, "controlMode", SkillControlMode.None);
        SetField(skill, "targetMask", SkillTargetMask.Enemy | SkillTargetMask.Elite | SkillTargetMask.Boss);
    ...
    public static SkillDefinition CreateBombermanKopniak()
    {
        ...
        SetField(skill, "activeSeconds", 0.10f);
        SetField(skill, "recoverySeconds", 0.18f);
        SetField(skill, "windupMoveMultiplier", 0.5f);
        SetField(skill, "recoveryMoveMultiplier", 0.5f);
        SetField(skill, "locksFacingInActive", true);
        SetField(skill, "cooldownSeconds", 3.0f);
        SetField(skill, "maxCharges", 1);
        SetField(skill, "cooldownStartsOnActive", true);
        SetField(skill, "aimMode", SkillAimMode.FacingVector);
        SetField(skill, "locomotion", SkillLocomotionMode.Root);
        ...
        SetField(skill, "chargeSpeed", DeployableTuning.KickSpeed);
        SetField(skill, "chargeRangeMeters", DeployableTuning.KickMaxDistance);
        SetField(skill, "capsuleWidthMeters", DeployableTuning.KickCapsuleWidth);
        SetField(skill, "capsuleLengthMeters", DeployableTuning.KickCapsuleLength);
        SetField(skill, "radiusMeters", DeployableTuning.KickCapsuleLength);
        SetField(skill, "maxTargets", 8);
        SetField(skill, "damage", 0f);
        SetField(skill, "controlMode", SkillControlMode.None);
        SetField(skill, "knockbackForce", 0f);
